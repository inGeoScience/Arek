var ajaxhome='arek.index.city';                                     // 站点
var ajaxcontent = 'integrity';                                                   //需要ajax加载的内容
var ajaxsearch_class = 'blog_search';                                       //搜索框class
var ajaxignore_string = new String('#, /wp-, .pdf, .zip, .rar, /goto, /msgboard');     //不需要ajax加载的页面，若permalink为%postname%，则填写Slug的内容
...
function removeStyle(){
    var inDiv = document.getElementById("integrity");
    inDiv.removeAttribute("style");
}
